...
//--------------------------------------------------------------------------------------------------------------------------------
    isParseMethodSuccess = http_parseMethod(request, requestData);
...
//--------------------------------------------------------------------------------------------------------------------------------
    isMethodGetHttpParsed = http_parseHttpVersion(request, requestData);
//--------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------
    http_parseQuaryParameters(request, requestData);
...
//--------------------------------------------------------------------------------------------------------------------------------
    char* isoltedMethod = http_isolateData(requestData, requestData[0], ' ');

    char* isolatedQueryParameters = http_isolateData(requestData, '?', ' ');
    
    char* alterateRequestData = strchr(requestData, '\n');
    alterateRequestData++;
    char* isolatedUrl = http_isolateData(alterateRequestData, alterateRequestData[0], '\n');

    char* alteradeRequest = strchr(requestData, '/');
    char* isolatedHttp = http_isolateData(alteradeRequest, ' ', '\n');
...
//--------------------------------------------------------------------------------------------------------------------------------
    isParseHeadersExist = http_parseHeaders(request, requestData);
