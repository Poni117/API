...
void antiSound_list_testAdd(list_t* list)
{
    ...
    int length = antiSound_list_length(list);
...
void antiSound_list_testRemove(list_t* list)
{
    ...
    int lengthBeforeRemove = antiSound_list_length(list);
    
    list_t* removableItem = antiSound_list_getItem(list, id);

    status = antiSound_list_remove(list, removableItem->id);

    list_t* item = antiSound_list_getItem(list, removableItem->id);
    list_t* previousItem = antiSound_list_getItem(list, item->id - 1);
    list_t* nextItem = antiSound_list_getItem(list, item->id + 1);

    int lengthAfterRemove = antiSound_list_length(list);
